         ...
         <div class="col-12 col-md-12 col-lg-12 justify-content-center">
            <form class="form" id="contactform">
                ...
                <div class="form-check-inline">
                    <input type="checkbox" class="form-check-input" id="terms" value="I accept the terms of identification and sharing." name="terms">
                    <label class="form-check-label" for="terms">I authorize my identification and the sharing of my question/considerations.</label>
                </div>
                <div class="form-group">
